...
index_last_odd.0:index_last_odd.c index_first_odd.h
	gcc -c index_last_odd.c
sum_between_even_odd.o:sum_between_even_odd.c sum_between_even_odd.h index_first_even.h index_last_odd.h
